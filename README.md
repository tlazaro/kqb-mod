...
October 2022 the [game servers were shut down](https://www.gamedeveloper.com/pc/-i-killer-queen-black-i-will-shut-down-in-november-confirms-liquid-bit). With local play being the only option, the community wasn't be able to continue playing together, with the only option left being in the same location to play on the same computer. It didn't have to be this way, the game was built in such a way that LAN play works. For the community and the people who love this game and wanted to continue playing, this mod was shared and used within closed groups.

In 2026, so long after the game is no longer available, I'm making this public.
